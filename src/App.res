...
let make = () => {
  ...
  <div className=`mt-32 container mx-auto flex flex-row justify-center`>
  <div className=`h-80 bg-red-500 rounded-xl text-white flex flex-col justify-between p-8`>
